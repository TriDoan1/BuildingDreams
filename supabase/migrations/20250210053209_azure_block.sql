/*
  # Update projects schema and data

  1. Changes
    - Add budget column to projects table
    - Add location and coordinates columns
    - Update existing projects with unique data

  2. Schema Updates
    - budget: numeric(10,2) for project budgets
    - location: text for city name
    - latitude: double precision for geo coordinates
    - longitude: double precision for geo coordinates

  3. Data Updates
    - Set unique budgets between $10,000 and $50,000
    - Assign locations in Orange County
